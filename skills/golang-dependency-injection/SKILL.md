...
description: "Design or refactor Go dependency wiring through constructor injection and lifecycle planning, and compare DI approaches before using library-specific skills."
user-invocable: true
license: MIT
