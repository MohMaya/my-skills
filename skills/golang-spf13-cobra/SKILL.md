...
description: "Build, extend, or review Go command trees with spf13/cobra, including flags, hooks, and completions; configuration layering and general CLI architecture use separate skills."
user-invocable: true
license: MIT
