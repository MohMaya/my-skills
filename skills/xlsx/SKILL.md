---
name: xlsx
description: "Create, read, analyze, or edit spreadsheet files (.xlsx/.xlsm/.xltx/.csv/.tsv), including Excel reports; excludes non-spreadsheet deliverables and Google Sheets API integration."
