...
description: "Look up published Go package documentation, versions, and vulnerabilities with godig; excludes local build navigation, library selection, and dependency upgrades."
user-invocable: true
license: MIT
