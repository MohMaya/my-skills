---
name: architect
description: "Sketch types, signatures, and module structure before code, then stay in the loop while implementation fills in. Use for /architect, 'architect this', or non-trivial code where jumping in would lock in the wrong types or module shape. Visual and product design belong to pe-design."
